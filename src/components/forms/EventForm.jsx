...
const EventForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Validación simple: puedes agregar más según tu lógica
        if (!selectedFile) {
            toast({
    ...
    return (
        <>
            ...
            <div className="login-container-Event">
                <div className="login-content" style={{ width: "100%", maxWidth: 400 }}>
                    ...
                    <form className="login-form" onSubmit={handleSubmit}>
                        ...
                        <div className="input-group">
                            <textarea
                                ...
                                onChange={handleChange}
                                required
                                style={{ resize: "none", height: 80, width: 250, marginBottom: 20 }}
                            />
                        </div>
                        <div className="input-group">
                            <input
                        ...
                        <div className="input-group">
                            <select
                                ...
                                value={form.type}
                                onChange={handleChange}
                                style={{ width: 200, minHeight: 24, marginBottom: 20 }}
                            >
